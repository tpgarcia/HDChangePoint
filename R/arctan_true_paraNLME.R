...
#' results<-main.arctan.nlme(n=n, model=model, dat=outdat, num.boot=num.boot, num.grid=num.grid,
...
#'
#'
main.arctan.nlme<-function(n=80, model="arctan", dat=outdat, num.boot=1000,   num.grid=45, true.gam1=2.45/pi, true.gam3=pi/1.1, para1=0.8,  para2=0.2, para3=0.2, para4=2.8, para5=1.5,  eps.sd=0.05, dist="normal"){
  ...
  return(list(  new.pred.data=new.pred.data, est.gam1=est.gam1, est.gam3=est.gam3,est.gam4=est.gam4, est.beta=est.beta, est.beta0=est.beta0, #estimates
                ...
                cp.lower.beta0=cp.lower.beta0, cp.upper.beta0=cp.upper.beta0, cp.lower.beta=cp.lower.beta, cp.upper.beta=cp.upper.beta, #coverage prob #newgrdata=newgrdata,
                sig.eps=sig.eps, #cp_sigma_eps_lower=cp_sigma_eps_lower, cp_sigma_eps_upper=cp_sigma_eps_upper, str.sigma.eps=str.sigma.eps,
