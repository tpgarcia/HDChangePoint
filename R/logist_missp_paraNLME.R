...
#'
#'
main.logistic.missp.nlme<-function(n=80, model="arctan",  num.boot=1000, dat=outdat, num.grid=45, true.gam1=2.45/pi, true.gam3=pi/1.1,  para1=3.1, para2=0.2, para3=0.2, para4=1.5, eps.sd=0.05, dist="normal"){
