...
# the parametric NLME estimation is performed under the logistic  model  (misspecified)  ##
###########################################################################################
...
#'         but the parametric NLME estimation is performed under the incorrect (logistic) model.
#' @export
#'
...
#'
#'                                 main.logistic.missp.nlme(n=80, model="arctan", dat=outdat, num.boot=1000,   num.interp=45, true.gam1=2.45/pi, true.gam3=pi/1.1, para1=4.3,
#'                                              para2=0.1, para3=0.1, para4=1.5,  eps.sd=0.05, dist="normal")
#'                                 }
#'             stopCluster(cl)
#'
#'
main.logistic.missp.nlme<-function(n=80, model="arctan",  num.boot=1000, dat=outdat, num.interp=45, true.gam1=2.45/pi, true.gam3=pi/1.1,  para1=3.1, para2=0.2, para3=0.2, para4=1.5, eps.sd=0.05, dist="normal"){
  ...
  return(list( new.pred.data=new.pred.data, est.beta=est.beta,est.beta0=est.beta0,
...
# Missplecfied by logistic Model           ##
#############################################
#' Title
#'
#' @param nsim
...
#'         arctangent model, but the estimation is performed under the logistic model.
#' @export
#'
#' @examples  simus.missp.logist.out<-missp.logist.results(nsim=100, n=80, res=results, num.interp=45,  beta=0.1, beta0=2,  file="nlme_arctan_")
#'
#'
missp.logist.results<-function(nsim=100, n=80, res=results, beta=0.1, beta0=2, num.interp=45,  file="nlme_logisic"){
