...
#' results<-main.arctan.nlme(n=n, model=model, dat=outdat, num.boot=num.boot, num.grid=num.grid, true.gam1=true.gam1,
#'                           true.gam3=true.gam3, para1=para1, para2=para2, para3=para3, para4=para4, para5=para5,
#'                           eps.sd=eps.sd, dist=dist)
#'
#'
...
#'
#' ## summary results
#' simus.arctan.out<-arctan.results(nsim=nsim, n=n, res=results, num.grid=num.grid, true.gam1=true.gam1,
#'                                  true.gam3=true.gam3, true.gam4=true.gam4,  beta=beta, beta0=beta0,  file=file)
#'
#'
#'
arctan.results<-function(nsim=100, n=80, res=results, num.grid=45, true.gam1=(2.45/pi), true.gam3=(pi/1.1), true.gam4=0.8,  beta=0.1, beta0=2,  file="nlme_arctan_"){
  ...
  ## 95% boostrap confidence intervals
